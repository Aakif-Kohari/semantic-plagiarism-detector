...
src.db.auth._DB_PATH = os.path.join(
    SEED_DIR,
    "users.db",
)
src.db.corpus_db._DB_PATH = os.path.join(
    SEED_DIR,
    "corpus.db",
)
src.db.incidents.DEFAULT_DB_PATH = os.path.join(
    SEED_DIR,
    "corpus.db",
)
...
class SeedConfig:
    """Validated seed-generator configuration."""
