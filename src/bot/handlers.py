async def handle_claim_force_command(comment_body: str, comment_author: str, issue_number: int, repo_client) -> bool:
    """
    ...
    try:
        ...
        print(f"Successfully force-assigned issue #{issue_number} to {target_user} by {comment_author}.")
        return True
