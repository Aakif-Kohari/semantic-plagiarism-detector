...
ENGLISH_STOPWORDS = {
    ...
    # Prepositions
    "of", "to", "in", "for", "on", "at", "from", "by",
    "with", "without", "about", "against", "between",
    "into", "through", "during", "before", "after",
    "above", "below", "up", "down", "off", "over",
    "under", "upon", "across", "among", "throughout",
    ...
    "doing", "will", "would", "shall", "should", "can",
    "could", "may", "might", "must",
    # Common adverbs
    "very", "too", "so", "than", "then", "now", "just",
    "only", "also", "too", "very", "just",
    # Other common words
    "not", "no", "nor", "never", "none",
    "all", "each", "every", "few", "many", "more",
    "most", "other", "some", "any", "such",
    "there", "here", "where", "why", "how",
...
ACADEMIC_STOPWORDS = {
    ...
    "appendix", "reference", "bibliography", "citation",
    "abstract", "introduction", "conclusion", "discussion",
    "methodology", "results", "analysis", "finding",
    "study", "research", "paper", "article", "journal",
    "author", "year", "volume", "issue", "page",
    "doi", "url", "http", "https", "www",
    "et", "al", "ibid", "op", "cit",
    "see", "also", "e.g.", "i.e.", "etc",
    "fig", "tab", "eq", "sec",
}
            ...
            if custom_path.exists():
                with open(custom_path, 'r') as f:
                    ...
                    if isinstance(data, list):
                        ...
                        logger.info(f"Loaded {len(self.custom)} custom stopwords from file")
