...
LANGUAGE_STOPWORDS = {
    'arabic': {
        'من', 'في', 'على', 'إلى', 'عن', 'مع', 'بين', 'بعد', 'قبل',
        'كان', 'كانت', 'يكون', 'تصبح', 'أصبح', 'ظل', 'بات',
        'أن', 'إن', 'إذا', 'لو', 'لما', 'حيث', 'هذا', 'هذه',
        'ذلك', 'تلك', 'الذي', 'التي', 'الذين', 'اللاتي',
        'عند', 'لدي', 'لدى', 'لذلك', 'هناك', 'هنا',
        'كل', 'بعض', 'أي', 'أكثر', 'أقل', 'بينما', 'بسبب',
        'منذ', 'حتى', 'دون', 'ضمن', 'بلا', 'ومع', 'لكن',
        'لقد', 'قد', 'سوف', 'سيكون', 'كانوا', 'لهم',
        'علي', 'عليه', 'عليها', 'علينا', 'عليكم',
        'بنا', 'بك', 'به', 'بها', 'بهم', 'بكم',
    },
    'devanagari': {
        'और', 'यह', 'वह', 'जो', 'से', 'को', 'में', 'पर', 'तक',
        'का', 'की', 'के', 'ने', 'है', 'था', 'थी', 'थे',
        'था', 'थी', 'थे', 'हूँ', 'हो', 'हैं',
        'मैं', 'तुम', 'आप', 'वे', 'हम', 'उन्होंने',
        'एक', 'दो', 'तीन', 'चार', 'पाँच',
        'यही', 'वही', 'जिस', 'जिन', 'उस', 'इस',
        'कर', 'हुआ', 'हुई', 'हुए', 'रहे', 'रही',
        'सकता', 'सकती', 'सकते', 'चाहिए', 'सकें',
        'बहुत', 'काफी', 'थोड़ा', 'ज्यादा', 'कम',
    },
    'cyrillic': {
        'и', 'в', 'на', 'с', 'по', 'к', 'у', 'из', 'за',
        'от', 'до', 'для', 'без', 'между', 'через',
        'это', 'тот', 'весь', 'который', 'такой',
        'быть', 'являться', 'становиться', 'находиться',
        'очень', 'также', 'ещё', 'уже', 'теперь',
        'тогда', 'там', 'здесь', 'туда', 'сюда',
        'когда', 'где', 'куда', 'откуда', 'почему',
        'потому', 'поэтому', 'затем', 'после', 'прежде',
        'все', 'вся', 'всё', 'всех', 'всем', 'всеми',
        'этого', 'этому', 'этим', 'этом', 'этой',
    },
    'hebrew': {
        'את', 'על', 'אל', 'מן', 'בין', 'אצל', 'עם',
        'של', 'לי', 'לך', 'לו', 'לה', 'לנו', 'לכם', 'להם',
        'אני', 'אתה', 'את', 'אנחנו', 'אתם', 'הם',
        'הוא', 'היא', 'זה', 'זאת', 'אלה', 'אלו',
        'כי', 'אם', 'כאשר', 'מאחר', 'לפני', 'אחרי',
        'עוד', 'גם', 'רק', 'כל', 'אין', 'יש',
    },
}
