...
class TranslationService:
    ...
    def get_translations(
        ...
        if source_lang:
            translations = [t for t in translations if t.get("source_lang") == source_lang]
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "has_confidence": sum(1 for t in translations if t.get("confidence") is not None),
