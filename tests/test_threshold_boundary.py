...
class TestThresholdBoundary(unittest.TestCase):
    ...
    def test_threshold_exact_match_included(self):
        ...
        exact_matches = [doc for doc in self.test_documents if doc["score"] == threshold]
    ...
    def test_empty_document_list(self):
        ...
        self.assertEqual(
            len(matches),
            0,
            "Empty document list should return no matches"
        )
    ...
    def test_all_documents_above_threshold(self):
        ...
        self.assertEqual(
            len(matches),
            len(docs),
            "All documents above threshold should be included"
        )
    ...
    def test_all_documents_below_threshold(self):
        ...
        self.assertEqual(
            len(matches),
            0,
            "All documents below threshold should be excluded"
        )
    ...
    def test_floating_point_precision(self):
        ...
        self.assertIn(
            docs[1],
            matches,
            "Document with score 0.8000000001 should be included"
        )
        ...
        self.assertNotIn(
            docs[2],
            matches,
            "Document with score 0.7999999999 should be excluded"
        )
    ...
    def test_cli_boundary_output(self):
        ...
        self.assertEqual(
            result.returncode,
            0,
            "CLI should exit successfully for boundary case"
        )
        ...
        self.assertIn(
            "0.8000",
            result.stdout,
            "CLI should display documents at exact threshold"
        )
