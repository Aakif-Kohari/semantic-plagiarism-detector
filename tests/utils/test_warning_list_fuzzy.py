...
pytestmark = pytest.mark.skipif(
    not THEFUZZ_AVAILABLE, 
    reason="thefuzz library not installed"
)
...
class TestFilterWarningsFuzzy:
    ...
    def test_filter_fuzzy_match_typo(self):
        ...
        warnings = [
            {"doc_a": "plagiarism_essay_final.pdf", "doc_b": "source.pdf"}
        ]
    ...
    def test_filter_fuzzy_match_partial(self):
        ...
        warnings = [
            {"doc_a": "student_john_doe_submission.docx", "doc_b": "wiki.pdf"}
        ]
    ...
    def test_filter_fuzzy_respects_threshold(self):
        ...
        warnings = [
            {"doc_a": "document.pdf", "doc_b": "other.pdf"}
        ]
    ...
    def test_filter_fuzzy_disabled_falls_back_to_exact(self):
        ...
        warnings = [
            {"doc_a": "plagiarism_essay.pdf", "doc_b": "source.pdf"}
        ]
    ...
    def test_filter_fuzzy_checks_both_documents(self):
        ...
        warnings = [
            {"doc_a": "random.pdf", "doc_b": "plagiarism_source.pdf"}
        ]
