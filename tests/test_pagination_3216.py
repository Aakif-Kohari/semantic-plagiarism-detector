...
class TestNextPageProperty:
    ...
    def test_next_page_returns_none_at_end(self):
        ...
        page = PaginationPage.create(items=[1, 2, 3], page=3, per_page=10, total_items=25)
    ...
    def test_next_page_with_total_pages_one(self):
        ...
        page = PaginationPage.create(items=[1, 2, 3], page=1, per_page=10, total_items=3)
        assert page.next_page is None
...
class TestPrevPageProperty:
    def test_prev_page_exists(self):
        ...
        page = PaginationPage.create(items=[1, 2, 3], page=2, per_page=10, total_items=25)
...
class TestPropertiesWithEquality:
    def test_pages_with_same_properties_are_equal(self):
        page1 = PaginationPage.create(items=[1, 2, 3], page=1, per_page=10, total_items=25)
        page2 = PaginationPage.create(items=[1, 2, 3], page=1, per_page=10, total_items=25)
        assert page1 == page2

    def test_pages_with_different_properties_not_equal(self):
        page1 = PaginationPage.create(items=[1, 2, 3], page=1, per_page=10, total_items=25)
        page2 = PaginationPage.create(items=[1, 2, 3], page=2, per_page=10, total_items=25)
        assert page1 != page2
